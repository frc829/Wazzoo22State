...
public class HighShot extends ParallelCommandGroup {

  public HighShot(ShooterSubsystem shooterSubsystem, SingulatorSubsystem singulatorSubsystem,
      LifterSubsystem lifterSubsystem, IntakeSubsystem intakeSubsystem, PincerSubsystem pincerSubsystem, PoweredHoodSubsystem poweredHoodSubsystem) {
    InstantCommand chargeHigh = new InstantCommand(shooterSubsystem::setSpeedHigh, shooterSubsystem);
    InstantCommand powerHood = new InstantCommand(poweredHoodSubsystem::SpinForwards, poweredHoodSubsystem);
    InstantCommand setAngle = new InstantCommand(pincerSubsystem::PincerClosed, pincerSubsystem);
    ...
    SequentialCommandGroup fire = new SequentialCommandGroup(chargeHigh, waitUntilShooterAtSpeed, singulatorFire);
