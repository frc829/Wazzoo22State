...
public class DriveAutoFasterLinearSpeed extends CommandBase {
  ...
  public DriveAutoFasterLinearSpeed(Pose2d targetPosition, DriveSubsystem driveSubsystem) {
    xController = new PIDController(1.4, 0, 0);
    xController.setTolerance(0.05);
    yController = new PIDController(1.4, 0, 0);
