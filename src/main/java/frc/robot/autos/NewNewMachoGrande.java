...
public class NewNewMachoGrande extends SequentialCommandGroup {
        /** Creates a new OldFaithful. */

        public NewNewMachoGrande(
                ...
                ParallelRaceGroup shootHigh3 = new FarShotDialedRPM(shooterSubsystem, singulatorSubsystem,
                                lifterSubsystem, intakeSubsystem, pincerSubsystem, poweredHoodSubsystem, 3400)
                                                .withTimeout(2);
                ...
                DriveAuto grab4 = new DriveAuto(
                                new Pose2d(1.05, 0, Rotation2d.fromDegrees(-80)),
                                driveSubsystem);
                DriveAuto6 goToGoal1 = new DriveAuto6(
                                new Pose2d(0, -2.60, Rotation2d.fromDegrees(-80)),
                                driveSubsystem);
                DriveAuto5 goToGoal2 = new DriveAuto5(
                                new Pose2d(0, -2.65, Rotation2d.fromDegrees(-55)),
                                driveSubsystem);

                DriveAuto goToGoal3 = new DriveAuto(
                                new Pose2d(0.15, -6.56, Rotation2d.fromDegrees(-50)),
                                driveSubsystem);
                DriveAuto goToGoal4 = new DriveAuto(
                                new Pose2d(0, -2.70, Rotation2d.fromDegrees(-55)),
                                driveSubsystem);
                ...
                SequentialCommandGroup path2 = new SequentialCommandGroup(grab4, goToGoal1, goToGoal2);
                ParallelRaceGroup travelPathAndLoad2 = new ParallelRaceGroup(
                                load2,
                                path2);

                WaitCommand waitCommand = new WaitCommand(0.01);

                SequentialCommandGroup path3 = new SequentialCommandGroup(goToGoal3, waitCommand, goToGoal4);
