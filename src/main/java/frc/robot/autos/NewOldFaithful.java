...
public class NewOldFaithful extends SequentialCommandGroup {
        /** Creates a new OldFaithful. */

        public NewOldFaithful(
                ...
                WaitCommand killShoot1 = new WaitCommand(8);
                ...
                DriveAuto smidge = new DriveAuto(
                        new Pose2d(1.2, 0, Rotation2d.fromDegrees(-13)),
                        driveSubsystem);
                ...
                InstantCommand intakeUp = new InstantCommand(() -> intakearm.ArmUp(), intakearm);
