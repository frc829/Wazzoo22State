...
public class GabesDadsAuto extends SequentialCommandGroup {
        /** Creates a new OldFaithful. */

        public GabesDadsAuto(
                ...
                RunCommand charge2 = new RunCommand(() -> shooterSubsystem.setSpeedDialed(3500), shooterSubsystem);
                RunCommand charge3 = new RunCommand(() -> shooterSubsystem.setSpeedDialed(3500), shooterSubsystem);
                ...
                FarShotDialedRPM shooter2 = new FarShotDialedRPM(shooterSubsystem, singulatorSubsystem,
                                lifterSubsystem, intakeSubsystem, pincerSubsystem, poweredHoodSubsystem, 3500);

                DriveAutoFasterLinearSpeed path1 = new DriveAutoFasterLinearSpeed(
                                new Pose2d(1.10, 0, Rotation2d.fromDegrees(13)),
                                driveSubsystem);

                DriveAuto path2 = new DriveAuto(
                                new Pose2d(1.10, 2, Rotation2d.fromDegrees(90)),
                                driveSubsystem);

                DriveAuto path3 = new DriveAuto(
                                new Pose2d(1.10, 2, Rotation2d.fromDegrees(40)),
                                driveSubsystem);
                ...
                ParallelRaceGroup goToShoot3 = new ParallelRaceGroup(charge3, load3, path3, killTravel3);
