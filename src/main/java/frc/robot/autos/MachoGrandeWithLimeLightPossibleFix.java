...
public class MachoGrandeWithLimeLightPossibleFix extends SequentialCommandGroup {
        /** Creates a new OldFaithful. */

        public MachoGrandeWithLimeLightPossibleFix(
                ...
                InstantCommand intakeUp = new InstantCommand(() -> intakeArmSubsystem.ArmUp(), intakeArmSubsystem);
                InstantCommand intakeDown = new InstantCommand(() -> intakeArmSubsystem.ArmDown(), intakeArmSubsystem);
                WaitCommand waitwithIntakeFix = new WaitCommand(0.2);
                ParallelCommandGroup littleIntakeWait = new ParallelCommandGroup(intakeDown, waitwithIntakeFix);
