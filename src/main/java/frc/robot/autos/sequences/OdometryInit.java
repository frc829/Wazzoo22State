...
public class OdometryInit extends SequentialCommandGroup {

    public OdometryInit(DriveSubsystem driveSubsystem) {
        ...
        addCommands(resetGyro, resetOdometry, setFieldCentric);
    }
}
